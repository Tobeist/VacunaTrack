...
@clinical_bp.route('/clinico/api/nfc', methods=['POST'])
def api_scan_nfc():
    import re
...
@clinical_bp.route('/clinico/api/curp', methods=['POST'])
def api_search_curp():
...
@clinical_bp.route('/clinico/api/cert-nac', methods=['POST'])
...
@clinical_bp.route('/clinico/registrar', methods=['GET', 'POST'])
...
@clinical_bp.route('/clinico/api/dosis-por-inventario/<int:inventario_id>')
...
@clinical_bp.route('/clinico/api/inventarios-para-dosis/<int:dosis_id>')
...
@clinical_bp.route('/clinico/api/dosis-aplicables/<int:paciente_id>')
...
@clinical_bp.route('/clinico/inventario/confirmar', methods=['GET', 'POST'])
...
@clinical_bp.route('/clinico/perfil')
def profile():
    redir = _require_responsable()
    if redir:
        return redir
...
@clinical_bp.route('/clinico/perfil/foto', methods=['POST'])
